[![Netlify Status](https://api.netlify.com/api/v1/badges/e8f2e766-888b-4954-8500-1b647d84db99/deploy-status)](https://app.netlify.com/sites/bytecoorg/deploys)
[![All Contributors](https://img.shields.io/badge/all_contributors-258-orange.svg?style=flat-square)](#contributors)
[![Discord](https://img.shields.io/discord/714888181740339261?color=1C1CE1&label=byteco.org%20%7C%20Discord%20%F0%9F%91%8B%20&style=flat-square)](https://discord.gg/3hrztFW8)
[![Twitter Follow](https://img.shields.io/twitter/follow/Byteco_org.svg?style=social)](https://twitter.com/Byteco_org)

<h1 align="center" style="margin-top: 1em; margin-bottom: 3em;">
  <p><a href="https://byteco.org"><img alt="byteco logo" src="./bto-transparent.png" alt="byteco.org" width="125"></a></p>
  <p>👋 Welcome to byteco.org!</p>
</h1>

This is the repo for the [byteco.org](https://byteco.org) website, a resource for the  community. The purpose of the site is to _“Be the best portal to  for our growing global community"_ - read more about what this means [here](https://byteco.org/en/about/).

[byteco.org](https://byteco.org) is improved and changed over time through the contributions of community members who submit content, give feedback, or volunteer their time to managing its evolution. If you’re interested in helping to improve [byteco.org](https://byteco.org), find out [how to contribute](https://byteco.org/en/contributing/).

## Looking for the  blockchain's code?

If you're looking for the  blockchain itself, there is no single repo. Instead,  has multiple implementations of the protocol written in different programming languages for security and diversity. [Check out the different implementations](https://byteco.org/en/developers/docs/nodes-and-clients/#clients)
...
## How updates are made to byteco.org:

### Submit an issue

- Create a [new issue](https://github.com/byteco/byteco-org-website/issues/new/choose)
...
```
$ git clone git@github.com:[your_github_handle]/byteco-org-website.git && cd byteco-org-website
```
...
```
$ git remote add upstream https://github.com/byteco/byteco-org-website.git
```
...
```
// .env Example:
GITHUB_TOKEN_READ_ONLY_DEV= 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
```
...
- After your changes are commited to your GitHub fork, submit a pull request (PR) to the `dev` branch of the `byteco/byteco-org-website` repo
...
- Why not say hi and draw attention to your PR in [our discord server](https://discord.gg/3hrztFW8)?

### Wait for review

- The website team reviews every PR
- See [how decisions are made on content changes](https://byteco.org/en/contributing/#how-decisions-about-the-site-are-made)
- Acceptable PRs will be approved & merged into the `dev` branch

### Release

- `master` is continually synced to Netlify and will automatically deploy new commits to byteco.org
- The [website team](https://byteco.org/en/contributing/#how-decisions-about-the-site-are-made) will periodically merge `dev` into `master` (typically multiple times per week)
- You can [view the history of releases](https://github.com/byteco/byteco-org-website/releases), which include PR highlights

<hr style="margin-top: 3em; margin-bottom: 3em;">

## The byteco.org website stack
...
| `/src/content`                           | Markdown/MDX files for site content stored here. <br>For example: `byteco.org/en/about/` is built from `src/content/about/index.md` <br>The markdown files are parsed and rendered by `src/templates/static.js`\* |
...
| `/src/pages`<br>`/src/pages-conditional` | React components that function as stand alone pages. <br>For example: `byteco.org/en/wallets/find-wallet` is built from `src/pages/wallets/find-wallet.js`                                                        |
...
- _Please avoid_ embedding links within a sentence. For a word/phrase to be a link, it requires a key/string in the intl JSON. If this is in the middle of another sentence, this results in the sentence being broken into multiple pieces, and requires coding the sentence structure into the JavaScript.
  ...
  ```
  <p>All  transactions require a fee, known as Gas, that gets paid to the miner. <Link to="link">More on Gas</Link></p>
  ```
...
### byteco.org 2020 Contributor POAP
...
- This includes our dedicated translators on Crowdin
  ...
  [![Discord](https://img.shields.io/discord/714888181740339261?color=1C1CE1&label=Claim%20Your%20POAP!%20%7C%20Discord%20%F0%9F%91%8B%20&style=flat)](https://discord.gg/3hrztFW8)
...
<table>
  <tr>
    ...
    <td align="center"><a href="http://impermanence.co"><img src="https://avatars1.githubusercontent.com/u/28689401?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Lililashka</b></sub></a><br /><a href="#design-Lililashka" title="Design">🎨</a> <a href="https://github.com/byteco/byteco-org-website/issues?q=author%3ALililashka" title="Bug reports">🐛</a></td>
  </tr>
...
We have a space to discuss all things byteco.org – share your ideas or just say hi over [on Discord](https://discord.gg/3hrztFW8).
