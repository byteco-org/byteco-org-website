...
const cards = [
  ...
  },
  {
    ...
    title: <Translation id="page-wallets-your-byteco-account" />,
    description: <Translation id="page-wallets-your-byteco-account-desc" />,
  },
  {
      ...
      <StyledTwoColumnContent>
        <LeftColumn>
          ...
          <ul>
            <li>
              <p>
                <Translation id="page-wallets-byteco-account" />
              </p>
            </li>
            <li>
              <p>
                <Translation id="page-wallets-accounts-byteco-addresses" />
              </p>
            </li>
            <li>
              <p>
                <Translation id="page-wallets-byteco-wallet" />
              </p>
            </li>
          </ul>
          <p>
...
export const query = graphql`
  query {
    ...
    eth: file(relativePath: { eq: "bto-logo.png" }) {
      ...calloutImage
    }
