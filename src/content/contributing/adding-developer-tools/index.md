...
lang: en
description: Our criteria for listing developer tools on Byteco.org
sidebar: true
---

# Adding developer tools {#contributing-to-Bytecoorg-}
...
Many projects in the Byteco space are open source. We are more likely to list open-source projects that allows community developers to inspect the code and contribute to it.

---

## Add your developer tool {#how-decisions-about-the-site-are-made}

If you want to add a developer tool to Byteco.org and it meets the criteria, create an issue on GitHub.
