---
title: A guide to translating Byteco.org
lang: en
description: How to help with Byteco.org translations
sidebar: true
---

# Translating Byteco.org guide {#translating-Byteco-guide}
...
Translation Memory (TM) is a feature of Crowdin that stores all the previously translated strings across [Byteco.org](http://Byteco.org/). When a string is translated, it is automatically saved into our project TM. This could be a useful tool to help you save your time!
...
Byteco terminology is another crucial part of our translation work as often new tech terms will not be localized in many languages yet. Also, there are terms that have different meanings in different contexts. [More on translating Byteco terminology](#terminology)
...
_For names (brands, companies, people) and new tech terms (open, beacon chain, etc.)_

Byteco presents a lot of new terms that have been coined recently. Some terms will vary from translator to translator as there is no official translation in their respective language. Such inconsistencies can cause misunderstanding and decrease readability.
...
Thank you for reading through all of these. We hope this helps you to onboard our program. Feel free to join our [Discord translation channel](https://discord.gg) to ask questions and collaborate with other translators!
