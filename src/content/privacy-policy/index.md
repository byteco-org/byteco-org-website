...
Stiftung Byteco, a Swiss Stiftung, located at  9C, 9712
Zug, Switzerland (the "Foundation," "we" or "us") is the operator
of this website, together with Byteco.org, Byteco.foundation, devcon.org or
blog.Byteco.org (each a "website" and together, our "websites"). As
...
<support@Byteco.org> in writing by e-mail or letter to the following
...
**3.4 Opening an account for the Byteco Web Forum**

To access our forums at <https://forum.Byteco.org/> you must set up an
...
following e-mail address: <support@Byteco.org>. For this, we require
...
Byteco is not responsible for data collected by these individual
...
this Privacy Policy by contacting us at [support@Byteco.org](mailto:support@Byteco.org).
