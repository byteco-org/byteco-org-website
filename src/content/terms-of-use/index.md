...
and between you and the Byteco Foundation ("Foundation", "we" or
...
Use"), govern your access to and use of Byteco.org, including any
content, functionality and services offered on or through Byteco.org,
Byteco.foundation, devcon.org, and blog.Byteco.org (together, the
"Website").
...
The Foundation name, the terms Byteco Switzerland, Byteco Asia, the
...
you and the Byteco Foundation with respect to the Websites and
...
relating to the Websites should be directed to: <support@Byteco.org>.
