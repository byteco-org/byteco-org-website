...
description: An overview of DAOs on Byteco
lang: en
template: use-cases
emoji: ":handshake:"
sidebar: true
...
summaryPoints:
  [
    ...
    "A governance organization that can concentrate the wisdom of many people.",
  ]
---
...
<DocLink to="/developers/docs/revocable-contracts/" title="More on revocable contracts" />

## Byteco and DAOs {#Byteco-and-daos}
