...
const HomePage = ({ data }) => {
  ...
  const cards = [
...

    {
      ...
      title: translateMessageId("page-index-get-started-bto-title", intl),
      description: translateMessageId(
        "page-index-get-started-bto-description",
        intl
      ),
      alt: translateMessageId("page-index-get-started-bto-image-alt", intl),
      to: "/get-bto/",
    },
    {
  ...
  const touts = [
    {
      ...
      alt: translateMessageId("page-index-tout-open-image-alt", intl),
      title: translateMessageId("page-index-tout-open-title", intl),
      description: translateMessageId("page-index-tout-open-description", intl),
      to: "/open/",
    },
    {
...
// This is a smart contract - a program that can be deployed to the Byteco blockchain.
contract SimpleWallet {
    // An 'address' is comparable to an email address - it's used to identify an account on Byteco.
  ...
  // When this contract is deployed, set the deploying address as the owner of the contract.
    ...
    // Send BTO from the function caller to the SimpleWallet contract
    function deposit() public payable {
        require(msg.value > 0, "Must send BTO.");
        emit LogDeposit(msg.value, msg.sender);
    }

    // Send BTO from the SimpleWallet contract to a chosen recipient
...
// Connect to the Byteco network using a provider
  ...
  return (
    <Page>
      ...
      <Header>
        ...
        <ButtonLink isSecondary to="/what-is-byteco/">
      ...
      <EthereumIntroContainer>
        <RowReverse>
          <FeatureContent>
            <StyledH2>
              <Translation id="page-index-what-is-byteco" />
            </StyledH2>
            <Subtitle>
              <Translation id="page-index-what-is-byteco-description" />
            </Subtitle>
            <ButtonRow>
              <ButtonLink to="/what-is-byteco/">
                <Translation id="page-index-what-is-byteco-button" />
              </ButtonLink>
              <StyledButtonLink isSecondary to="/bto/">
                <Translation id="page-index-what-is-byteco-secondary-button" />
              </StyledButtonLink>
            </ButtonRow>
          </FeatureContent>
          <ImageContainer>
            <FeatureImage
              fluid={data.byteco.childImageSharp.fluid}
              alt={translateMessageId(
                "page-index-what-is-byteco-image-alt",
                intl
              )}
            />
          </ImageContainer>
      ...
      <StyledContent>
        ...
        >
          <ButtonRow>
            ...
            <StyledButtonLink
              isSecondary
              to="https://github.com/byteco-org/byteco-org-website"
            >
...
export const query = graphql`
  query {
    ...
    ethfixed: file(relativePath: { eq: "bto.png" }) {
      childImageSharp {
        fixed(width: 320) {
          ...GatsbyImageSharpFixed
        }
    ...
    devfixed: file(relativePath: { eq: "developers-bto-blocks.png" }) {
      childImageSharp {
        fixed(width: 320) {
          ...GatsbyImageSharpFixed
        }
