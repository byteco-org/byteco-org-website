...
//       name: "Ganache",
//       description:
//         "A personal blockchain for Byteco development you can use to deploy contracts, develop your applications, and run tests. It is available as both a desktop application as well as a command-line tool . Ganache is available for Windows, Mac, and Linux.",
//     },
//     {
//       id: "ethnode",
...
//       name: "ethnode",
//       description:
//         "ethnode is a zero configuration tool to run a local Byteco node. It supports both Open and Geth clients.",
//     },
//     {
//       id: "buidler",
...
//       background: "#56338C",
//       name: "VSCode Development Kit for Byteco",
//       description:
//         "The extension simplifies how you create, build and deploy smart contracts on Byteco ledgers.",
//     },
//     {
//       url:
//       id: "workbench",
...
//       name: "web3.js",
//       description:
//         "The Byteco JavaScript API which connects to the Generic JSON-RPC spec.",
//     },
//     {
//       id: "ethers",
...
//       name: "Ethers.js",
//       description:
//         "Complete Byteco library and wallet implementation in JavaScript – supports Typescript",
//     },
//   ]
    ...
    <StyledPage>
      ...
      <HeroContent>
        ...
        {/* <CardGrid>
          ...
          <StyledCard
            ...
            description="If you're not ready and want to brush up on your Byteco knowledge, check out our docs."
          ></StyledCard>
        </CardGrid> */}
      </HeroContent>
      <Content>
        <TwoColumnContent>
          ...
          <Column>
            <Hero
              fluid={data.hero.childImageSharp.fluid}
              alt={translateMessageId("alt-bto-blocks", intl)}
              loading="eager"
            />
          </Column>
        </TwoColumnContent>
      ...
      <StackContainer>
        ...
        <p>
          ...
          deploy it straight to to Byteco's public mainnet (it costs money).
      ...
      <StackContainer>
        ...
        <p>
          In order to write Byteco smart contracts, you'll need to use a
      ...
      <StackContainer>
        ...
        <p>
          ...
          Byteco developer frameworks come with smart contract testing out of
          the box
        </p>
        <Link to="/en/developers/docs/ides/">More on IDEs</Link>
        <CardGrid>
