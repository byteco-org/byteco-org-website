      ...
      <Content>
        ...
        <TwoColumnContent>
          ...
          <StyledCallout
            ...
            title={translateMessageId("page-developers-improve-bto", intl)}
            description={translateMessageId(
              "page-developers-improve-bto-desc",
              intl
            )}
            alt={translateMessageId("alt-bto-blocks", intl)}
          >
            <div>
              <ButtonLink to="https://github.com/byteco-org/byteco-org-website">
      ...
      <GrayContainer>
        ...
        <ThreeColumnContent>
          <Column>
            ...
            <Link to="/developers/docs/intro-to-bto/">
              <Translation id="page-developers-intro-bto-link" />
            </Link>
            <p>
              <Translation id="page-developers-into-bto-desc" />
            </p>
            ...
            <Link to="/developers/docs/bto-stack/">
...
export const query = graphql`
  query {
    ednHero: file(relativePath: { eq: "enterprise-bto.png" }) {
      childImageSharp {
        fluid(maxWidth: 800) {
    ...
    ogImage: file(relativePath: { eq: "enterprise-bto.png" }) {
      childImageSharp {
        fixed(width: 1200) {
          src
        }
