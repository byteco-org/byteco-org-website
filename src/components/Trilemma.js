...
const Trilemma = () => {
  ...
  let cardTitle = <Translation id="page-open-vision-trilemma-title-1" />
  let cardText = <Translation id="page-open-vision-trilemma-press-button" />
  if (isEth2) {
    cardTitle = <Translation id="page-open-vision-trilemma-title-2" />
    cardText = <Translation id="page-open-vision-trilemma-cardtext-1" />
  } else if (state.isDecentralizedAndSecure) {
    cardTitle = <Translation id="page-open-vision-trilemma-title-3" />
    cardText = <Translation id="page-open-vision-trilemma-cardtext-2" />
  } else if (state.isDecentralizedAndScalable) {
    cardTitle = <Translation id="page-open-vision-trilemma-title-4" />
    cardText = <Translation id="page-open-vision-trilemma-cardtext-3" />
  } else if (state.isScalableAndSecure) {
    cardTitle = <Translation id="page-open-vision-trilemma-title-5" />
    cardText = <Translation id="page-open-vision-trilemma-cardtext-4" />
  }
  return (
    <Container>
      <CardContainer>
        <H2>
          <Translation id="page-open-vision-trilemma-h2" />
        </H2>
        <p>
          <Translation id="page-open-vision-trilemma-p" />
        </p>
        <p>
          <Translation id="page-open-vision-trilemma-p-1" />
        </p>
        <p>
          <Translation id="page-open-vision-trilemma-p-2" />
        </p>
        <MobileTip>
          <Translation id="page-open-vision-trilemma-modal-tip" />:
        </MobileTip>
      ...
      >
        ...
        <Text x="460" y="150" isActive={isDecentralized}>
          <Translation id="page-open-vision-trilemma-text-1" />
        </Text>
        <Text x="-24" y="486" isActive={isSecure}>
          <Translation id="page-open-vision-trilemma-text-2" />
        </Text>
        <Text x="540" y="835" isActive={isScalable}>
          <Translation id="page-open-vision-trilemma-text-3" />
        </Text>
      </Triangle>
    </Container>
  )
