  ...
  const {
    ...
    graphql`
      query {
        ...
        ogImageDevelopers: file(relativePath: { eq: "enterprise-bto.png" }) {
          childImageSharp {
            fixed(width: 1200) {
              src
            }
        ...
        ogImageEthtwo: file(relativePath: { eq: "open/eth2_doge.png" }) {
          childImageSharp {
            fixed(width: 1200) {
              src
            }
  ...
  return (
    <Location>
      {({ location }) => {
        ...
        /* e.g. set byteco.org/about/ to byteco.org/en/about/ */
              ...
              {`
        {
          ...
          "@type": "Organization",
          "url": "https://byteco.org",
          "email": "press@byteco.org",
          "name": "Byteco",
          "logo": "https://byteco.org/og-image.png"
        }
      `}
            </script>
          </Helmet>
